...
#d is de hoeveelheid die de scintilator horizontaal beweegt, dus d=h tan(hoek) m
#h is de hoogte van de tafel, h=0.86 m
#w is half de breedte van de scintilator, w=0.045 m
#le is half de lengte van de scintilator, le=0.20 m
#Aeff is het effectieve oppervlak, en kan constant geschat worden, Aeff=0.56 m^2


def error_flux(tijd, Solid, Aeff, hoek_graad, N, d, h, w, le, Err_h, Err_d):
    ...
    Err_flux = math.sqrt((Err_N*par_flux_N)**2+(Err_Solid*par_flux_Solid)**2)
    return Err_flux
